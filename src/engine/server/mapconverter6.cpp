...
void CMapConverter6::InitQuad(CQuad* pQuad)
{
	for (int i=0; i<5; i++) {
...
void CMapConverter6::InitQuad(CQuad* pQuad, vec2 Pos, vec2 Size)
{
...
void CMapConverter6::AddImageQuad(const char* pName, int ImageID, int GridX, int GridY, int X, int Y, int Width, int Height, vec2 Pos, vec2 Size, vec4 Color, int Env)
{
	array<CQuad> aQuads;
	CQuad Quad;
...
void CMapConverter6::AddTeeLayer(const char* pName, int ImageID, vec2 Pos, float Size, int Env)
{
	array<CQuad> aQuads;
	CQuad Quad;
...
void CMapConverter6::CopyVersion()
{
...
void CMapConverter6::CopyMapInfo()
{
...
void CMapConverter6::CopyImages()
{
	int Start, Num;
...
void CMapConverter6::CopySounds()
{
	int Start, Num;
...
void CMapConverter6::CopyAnimations()
{
	int NumEnvPoints = 0;
	CEnvPoint* pEnvPoints = NULL;
	{
...
void CMapConverter6::CopyGameLayer()
{
...
void CMapConverter6::CopyLayers()
{
...
int CMapConverter6::AddExternalImage(const char* pImageName, int Width, int Height)
{
	CMapItemImage Item;
	Item.m_Version = 1;
	Item.m_External = 1;
...
void CMapConverter6::CreateCircle(array<CQuad>* pQuads, vec2 CenterPos, float Size, vec4 Color, int Env, int EnvTO)
{
	CQuad Quad;
	InitQuad(&Quad);
...
bool CMapConverter6::CreateMap(const char* pFilename)
{
	char aBuf[512];
