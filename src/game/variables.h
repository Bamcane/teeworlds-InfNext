...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 0, 0, 0, CFGFLAG_SERVER, "Score limit (Can't change)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 5, 1, 1000, CFGFLAG_SERVER, "Time limit in minutes")
